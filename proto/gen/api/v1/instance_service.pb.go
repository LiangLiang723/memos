...
type MigrateLocalAttachmentsToTemplateRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MigrateLocalAttachmentsToTemplateRequest) Reset() {
	*x = MigrateLocalAttachmentsToTemplateRequest{}
	mi := &file_api_v1_instance_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MigrateLocalAttachmentsToTemplateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrateLocalAttachmentsToTemplateRequest) ProtoMessage() {}

func (x *MigrateLocalAttachmentsToTemplateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrateLocalAttachmentsToTemplateRequest.ProtoReflect.Descriptor instead.
func (*MigrateLocalAttachmentsToTemplateRequest) Descriptor() ([]byte, []int) {
	return file_api_v1_instance_service_proto_rawDescGZIP(), []int{9}
}

func (x *MigrateLocalAttachmentsToTemplateRequest) GetBatchSize() int32 {
	if x != nil {
		return x.BatchSize
	}
	return 0
...
func (x *MigrateLocalAttachmentsToTemplateRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
type MigrateLocalAttachmentsToTemplateResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The number of local image attachments found before migration.
	Total int32 `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`
...
func (x *MigrateLocalAttachmentsToTemplateResponse) Reset() {
	*x = MigrateLocalAttachmentsToTemplateResponse{}
	mi := &file_api_v1_instance_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MigrateLocalAttachmentsToTemplateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrateLocalAttachmentsToTemplateResponse) ProtoMessage() {}

func (x *MigrateLocalAttachmentsToTemplateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_instance_service_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrateLocalAttachmentsToTemplateResponse.ProtoReflect.Descriptor instead.
func (*MigrateLocalAttachmentsToTemplateResponse) Descriptor() ([]byte, []int) {
	return file_api_v1_instance_service_proto_rawDescGZIP(), []int{10}
}

func (x *MigrateLocalAttachmentsToTemplateResponse) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *MigrateLocalAttachmentsToTemplateResponse) GetMigrated() int32 {
	if x != nil {
		return x.Migrated
	}
	return 0
...
func (x *MigrateLocalAttachmentsToTemplateResponse) GetSkipped() int32 {
	if x != nil {
		return x.Skipped
	}
	return 0
...
func (x *MigrateLocalAttachmentsToTemplateResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *MigrateLocalAttachmentsToTemplateResponse) GetNextOffset() int32 {
	if x != nil {
		return x.NextOffset
	}
	return 0
...
const file_api_v1_instance_service_proto_rawDesc = "" +
	...
	"(MigrateLocalAttachmentsToTemplateRequest\x12\"\n" +
	"\n" +
	"batch_size\x18\x01 \x01(\x05B\x03\xe0A\x01R\tbatchSize\x12\x1b\n" +
	"\x06offset\x18\x02 \x01(\x05B\x03\xe0A\x01R\x06offset\"\xb2\x01\n" +
	")MigrateLocalAttachmentsToTemplateResponse\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x05R\x05total\x12\x1a\n" +
	"\bmigrated\x18\x02 \x01(\x05R\bmigrated\x12\x18\n" +
	"\askipped\x18\x03 \x01(\x05R\askipped\x12\x18\n" +
	...
	"!MigrateLocalAttachmentsToDatabase\x126.memos.api.v1.MigrateLocalAttachmentsToDatabaseRequest\x1a7.memos.api.v1.MigrateLocalAttachmentsToDatabaseResponse\"E\x82\xd3\xe4\x93\x02?:\x01*\":/api/v1/instance/storage:migrateLocalAttachmentsToDatabase\x12\xdb\x01\n" +
	"!MigrateLocalAttachmentsToTemplate\x126.memos.api.v1.MigrateLocalAttachmentsToTemplateRequest\x1a7.memos.api.v1.MigrateLocalAttachmentsToTemplateResponse\"E\x82\xd3\xe4\x93\x02?:\x01*\":/api/v1/instance/storage:migrateLocalAttachmentsToTemplate\x12\x8f\x01\n" +
...
var file_api_v1_instance_service_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_api_v1_instance_service_proto_goTypes = []any{
	...
	(*MigrateLocalAttachmentsToTemplateRequest)(nil),               // 12: memos.api.v1.MigrateLocalAttachmentsToTemplateRequest
	(*MigrateLocalAttachmentsToTemplateResponse)(nil),              // 13: memos.api.v1.MigrateLocalAttachmentsToTemplateResponse
	(*VacuumDatabaseRequest)(nil),                                  // 14: memos.api.v1.VacuumDatabaseRequest
	(*VacuumDatabaseResponse)(nil),                                 // 15: memos.api.v1.VacuumDatabaseResponse
	...
	(*InstanceSetting_MemoRelatedSetting_MapSetting)(nil),          // 21: memos.api.v1.InstanceSetting.MemoRelatedSetting.MapSetting
	(*User)(nil),                  // 22: memos.api.v1.User
	(*fieldmaskpb.FieldMask)(nil), // 23: google.protobuf.FieldMask
}
var file_api_v1_instance_service_proto_depIdxs = []int32{
	22, // 0: memos.api.v1.InstanceProfile.admin:type_name -> memos.api.v1.User
	...
	23, // 5: memos.api.v1.UpdateInstanceSettingRequest.update_mask:type_name -> google.protobuf.FieldMask
	19, // 6: memos.api.v1.InstanceSetting.GeneralSetting.custom_profile:type_name -> memos.api.v1.InstanceSetting.GeneralSetting.CustomProfile
	...
	20, // 8: memos.api.v1.InstanceSetting.StorageSetting.s3_config:type_name -> memos.api.v1.InstanceSetting.StorageSetting.S3Config
	21, // 9: memos.api.v1.InstanceSetting.MemoRelatedSetting.map_setting:type_name -> memos.api.v1.InstanceSetting.MemoRelatedSetting.MapSetting
	...
	12, // 16: memos.api.v1.InstanceService.MigrateLocalAttachmentsToTemplate:input_type -> memos.api.v1.MigrateLocalAttachmentsToTemplateRequest
	14, // 17: memos.api.v1.InstanceService.VacuumDatabase:input_type -> memos.api.v1.VacuumDatabaseRequest
	3,  // 18: memos.api.v1.InstanceService.GetInstanceProfile:output_type -> memos.api.v1.InstanceProfile
	5,  // 19: memos.api.v1.InstanceService.GetInstanceSetting:output_type -> memos.api.v1.InstanceSetting
	5,  // 20: memos.api.v1.InstanceService.UpdateInstanceSetting:output_type -> memos.api.v1.InstanceSetting
	9,  // 21: memos.api.v1.InstanceService.MigrateDatabaseAttachmentsToLocal:output_type -> memos.api.v1.MigrateDatabaseAttachmentsToLocalResponse
	11, // 22: memos.api.v1.InstanceService.MigrateLocalAttachmentsToDatabase:output_type -> memos.api.v1.MigrateLocalAttachmentsToDatabaseResponse
	13, // 23: memos.api.v1.InstanceService.MigrateLocalAttachmentsToTemplate:output_type -> memos.api.v1.MigrateLocalAttachmentsToTemplateResponse
	15, // 24: memos.api.v1.InstanceService.VacuumDatabase:output_type -> memos.api.v1.VacuumDatabaseResponse
