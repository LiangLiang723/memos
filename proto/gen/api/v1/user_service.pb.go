...
type UserSetting_GeneralSetting struct {
	...
	CommentDefaultVisibility string `protobuf:"bytes,5,opt,name=comment_default_visibility,json=commentDefaultVisibility,proto3" json:"comment_default_visibility,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *UserSetting_GeneralSetting) GetCommentDefaultVisibility() string {
	if x != nil {
		return x.CommentDefaultVisibility
	}
	return ""
}
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\xf4\x04\n" +
	...
	"\x10webhooks_setting\x18\x05 \x01(\v2).memos.api.v1.UserSetting.WebhooksSettingH\x00R\x0fwebhooksSetting\x1a\xb9\x01\n" +
	...
	"\x05theme\x18\x04 \x01(\tB\x03\xe0A\x01R\x05theme\x12A\n" +
	"\x1acomment_default_visibility\x18\x05 \x01(\tB\x03\xe0A\x01R\x18commentDefaultVisibility\x1aH\n" +
