...
export type UserSetting_GeneralSetting = Message<"memos.api.v1.UserSetting.GeneralSetting"> & {
  ...
  /**
   * The default visibility of the memo comments.
   *
   * @generated from field: string comment_default_visibility = 5;
   */
  commentDefaultVisibility: string;
};
